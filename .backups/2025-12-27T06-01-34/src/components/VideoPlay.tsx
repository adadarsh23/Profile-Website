...
const VideoPlayer = ({ src }: { src: string }) => {
  ...
  const togglePlay = () => {
    // This check is important because videoRef will be null for YouTube videos
  ...
  const isYoutubeVideo = src.includes('youtube.com/embed/');

  if (isYoutubeVideo) {
    return (
      <motion.div
        className="relative w-full max-w-4xl mx-auto rounded-xl overflow-hidden bg-[#11111198] shadow-[0_0_20px_rgba(0,0,0,0.2)] backdrop-blur-sm p-1"
