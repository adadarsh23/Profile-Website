            ...
            <div className="relative p-1 rounded-xl bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 shadow-inner">
              ...
              <div className="relative p-1 rounded-lg bg-gradient-to-br from-gray-700 via-gray-600 to-gray-700 group-hover:from-gray-500 group-hover:via-gray-400 group-hover:to-gray-500 transition-all duration-700">
                <iframe
                  ...
                  src="https://open.spotify.com/embed/album/6n4QRnfZ9SC7NXDftKam4S?utm_source=generator&theme=0"
                  width="100%"
                  height="352"
                  allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture; web-share; user-media; microphone; camera; midi; vr; xr-spatial-tracking; document-domain-access; gyroscope; accelerometer; ambient-light-sensor; payment; screen-wake-lock;  usb; bluetooth; persistent-storage; interest-cohort;  cross-origin-isolated;  display-capture;  gamepad;  magnetometer; nfc;  payment-crypto;  payment-method;  speaker;  usb;  web-share;  web-hid;  web-usb;  xr-spatial-tracking;  sync-xhr;  sync-xhr-invisible;  web-nfc;  web-transport;  web-bundles"
                  frameBorder="0"
