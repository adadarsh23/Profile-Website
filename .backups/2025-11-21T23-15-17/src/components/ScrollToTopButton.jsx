  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-center w-full h-full">
        ...
        <span className="absolute text-xs sm:text-sm lg:text-base font-bold text-white dark:text-gray-200 opacity-0 scale-75 transition-all duration-200 ease-in-out group-hover:opacity-100 group-hover:scale-100">
