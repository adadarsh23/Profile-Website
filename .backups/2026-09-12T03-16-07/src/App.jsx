...
// Pages
const Home = loadComponent(() => import('@/pages/Home.jsx'));
const About = loadComponent(() => import('@/pages/About.jsx'));
const Contact = loadComponent(() => import('@/pages/Contact.jsx'));
const Sample = loadComponent(() => import('@/pages/Sample.jsx'));
const Gallery = loadComponent(() => import('@/pages/Gallery.tsx'));
const Blog = loadComponent(() => import('@/pages/Blog.jsx'));
const NotFound = loadComponent(() => import('@/pages/NotFound.jsx'));
...
const InternetStatus = loadComponent(
  () => import('./components/InternetStatus.jsx')
);
const CacheClean = loadComponent(() => import('@/components/CacheClean.jsx'));
...
const SplashCursor = loadComponent(
  () => import('./components/SplashCursor.jsx')
);
