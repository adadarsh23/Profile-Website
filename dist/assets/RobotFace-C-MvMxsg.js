const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/RobotHead-Bqq280MX.js',
      'assets/vendor-DEG5g0yW.js',
      'assets/AIChatCard-BIDt_FYR.js',
...
import { c as x } from './utils-65uuWg0a.js';
import { E as g } from './index-Cxrg4Q2y.js';
const w = t,
  b = a,
  y = n,
...
const R = e.memo(() =>
  ...
  C = e.lazy(() =>
    p(() => import('./RobotHead-Bqq280MX.js'), __vite__mapDeps([0, 1]))
  ),
  L = e.lazy(() =>
    p(
      () => import('./AIChatCard-BIDt_FYR.js'),
          ...
          children: s.jsxs(u, {
            ...
            children: [
              ...
              s.jsxs(e.Suspense, {
                fallback: null,
                children: [
                  s.jsx(C, { cursor: t, velocity: a, isHovered: n }),
                  s.jsx(m, { preset: 'city' }),
                ],
              }),
            ],
