const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      'assets/Hyperspeed-DKyRrFij.js',
      'assets/BlurText-aIIrJdMN.js',
    ])
) => i.map((i) => d[i]);
import { j as e, r as t, _ as i } from './vendor_react-C8wG62CJ.js';
import './vendor-Grk_15WJ.js';
import './vendor_react-dom-DKAsGG5-.js';
const r = t.lazy(() =>
    i(
      () => import('./index-BtU_4mIL.js').then((s) => s.a),
      __vite__mapDeps([0, 1, 2, 3, 4])
    )
  ),
  l = t.lazy(() =>
    i(() => import('./Hyperspeed-DKyRrFij.js'), __vite__mapDeps([5, 1, 2, 3]))
  ),
  a = t.lazy(() =>
    i(() => import('./BlurText-aIIrJdMN.js'), __vite__mapDeps([6, 1, 2, 3]))
  );
function x({ onAnimationComplete: s }) {
  const o = () => {
    s?.();
  };
    ...
    children: [
      e.jsx('div', {
        ...
        children: e.jsx(t.Suspense, {
          fallback: e.jsx('div', { children: e.jsx(r, {}) }),
          children: e.jsx(l, {
            effectOptions: {
              onSpeedUp: () => {},
              onSlowDown: () => {},
