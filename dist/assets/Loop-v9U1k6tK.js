const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/LogoLoop-DbkYjaK2.js',
      'assets/vendor-C8sBI81f.js',
      'assets/CurvedLoop-Dain8CgK.js',
...
const _ = [
  ...
  b = j.lazy(() =>
    v(() => import('./LogoLoop-DbkYjaK2.js'), __vite__mapDeps([0, 1]))
  ),
  A = j.lazy(() =>
    v(() => import('./CurvedLoop-Dain8CgK.js'), __vite__mapDeps([2, 1]))
  ),
  L = j.lazy(() =>
    v(
  ...
  const t = j.useMemo(
      () =>
        Array.from({ length: 4 }).map(() => {
          return {
            speed:
              ((e = M), (t = T), Math.floor(Math.random() * (t - e + 1)) + e),
