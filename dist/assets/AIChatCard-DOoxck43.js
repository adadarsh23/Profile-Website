const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/ChatInput-DYvQGbE1.js',
      'assets/vendor-CLKqtzgM.js',
      'assets/utils-xZivFseN.js',
      'assets/ChatMessageBubble-B7fN8Swi.js',
    ])
) => i.map((i) => d[i]);
import {
  r as e,
...
import { c as l } from './utils-xZivFseN.js';
import { l as c } from './index-TjyNd_uT.js';
function delay(e) {
...
const u = e.memo(({ status: e }) =>
  ...
  m = e.lazy(() =>
    o(() => import('./ChatInput-DYvQGbE1.js'), __vite__mapDeps([0, 1, 2]))
  ),
  f = e.lazy(() =>
    o(
      () => import('./ChatMessageBubble-B7fN8Swi.js'),
      __vite__mapDeps([3, 1, 2])
    )
  );
function AIChatCard({ className: o, onClose: w }) {
  const {
      messages: x,
      setMessages: g,
      clearSession: p,
      ...
      e.useEffect(() => {
        try {
          sessionStorage.setItem(h, JSON.stringify(s));
        } catch (e) {}
      }, [s]);
      const n = e.useCallback(() => {
        try {
          (sessionStorage.removeItem(h), a([...t]));
        } catch (e) {}
      }, [t]);
      return { messages: s, setMessages: a, clearSession: n };
    })([
      {
        sender: 'ai',
    ...
    { updateMemory: y } = (function () {
      const [t, s] = e.useState(null);
      return {
        memory: t,
        updateMemory: e.useCallback((e) => {
          if (0 === e.length) return void s(null);
          const t = e.map((e) => e.text).join(' '),
            a = t
              .toLowerCase()
              .match(/\b\w+\b/g)
              ?.filter((e) => e.length >= 4 && !d.has(e))
            ...
            n = a
              ? Object.entries(a)
                  ...
                  .map(([e]) => e)
              : [],
            r = t.length > 250 ? `...${t.slice(-250)}` : t;
          s({ summary: r, keywords: n });
        }, []),
      };
    })(),
    [b, j] = e.useState(''),
  ...
  const C = e.useCallback(
      async (e) => {
        const t = (e || b).trim();
        if (!t || 'idle' !== v) return;
        const s = { sender: 'user', text: t, timestamp: Date.now() };
        (g((e) => [...e, s]), j(''), N('thinking'));
        try {
          ...
          const e = await (async function (e) {
              ...
              for (; s < 3; )
                try {
                  ...
                  if ((clearTimeout(a), !n.ok)) {
                    if (429 === n.status) {
                      (s++, await delay(1500 * s));
                      continue;
                    }
            ...
            a = { sender: 'ai', text: t, timestamp: Date.now() };
          (g((e) => [...e, a]), y([...x, s, a]));
        } catch (a) {
          const e = {
            sender: 'ai',
    ...
    k = e.useCallback(() => {
      ...
      const e = new Date(),
        ...
        n = new Blob([a + s], { type: 'text/plain' }),
