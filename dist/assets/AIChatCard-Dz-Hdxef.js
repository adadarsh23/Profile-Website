const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/ChatMessageBubble-axpUPKnW.js',
      'assets/vendor-iWomKbAA.js',
      'assets/utils-DfWtT5OB.js',
      'assets/ChatInput-BafkuaZI.js',
    ])
) => i.map((i) => d[i]);
import {
  r as e,
...
import { c } from './utils-DfWtT5OB.js';
...
function useChatSession(t) {
  ...
  return { messages: n, setMessages: a, clearSession: i };
}
    ...
    const t = e
      ...
      i = a
        ? Object.entries(a)
            ...
            .map(([e]) => e)
        : [],
      s = e.find((e) => 'user' === e.sender),
      o = e.slice(-4);
    let r = o.map((e) => `${e.sender}: ${e.text}`).join('\n');
    s && !o.includes(s) && (r = `Initial topic: ${s.text}\n...\n` + r);
    const l = r.length > 300 ? `...${r.slice(-300)}` : r;
    n({ summary: l, keywords: i });
  }, []);
...
const u = {
    ...
    galleryImages: [
      ...
      {
        id: 2,
        image: 'https://i.ibb.co/39HW4P07/Photo2.jpg',
        text: '23',
        orientation: 'portrait',
        width: 300,
        height: 400,
      ...
      {
        id: 3,
        image: 'https://i.ibb.co/6RF1WhR7/Photo3.jpg',
        text: 'Red Gradient',
        orientation: 'portrait',
        width: 300,
        height: 400,
            ...
            for (; n < 3; )
              try {
                ...
                if ((clearTimeout(a), !i.ok)) {
                  ...
                  throw new Error(`Gemini request failed (${i.status})`);
                }
                const s = await i.json();
                return (
                  s.data?.candidates?.[0]?.content?.parts?.[0]?.text ||
...
function ChatHeader({ onShare: e, onExport: r, onClear: l, onClose: c }) {
  const d = { hidden: { y: -20, opacity: 0 }, visible: { y: 0, opacity: 1 } };
  return t.jsxs(n.div, {
    className:
    ...
    children: [
      t.jsx(n.div, {
        variants: d,
        animate: { scale: 1.05 },
        transition: { duration: 2, repeatType: 'reverse', ease: 'easeInOut' },
      }),
      t.jsx(n.h2, {
...
const g = e.memo(({ width: e = 24, height: n = 24 }) =>
  ...
  w = e.lazy(() =>
    l(
      () => import('./ChatMessageBubble-axpUPKnW.js'),
...
function ChatMessageList({
  ...
  return (
    e.useEffect(() => {
      const e = o.current;
      if (!e) return;
      const t = e.scrollHeight - e.scrollTop - e.clientHeight < 100,
        a = 'user' === n[n.length - 1]?.sender;
      (t || a || n.length <= 1) &&
...
const b = e.lazy(() =>
    l(() => import('./ChatInput-BafkuaZI.js'), __vite__mapDeps([3, 1, 2]))
  ),
  f = 1e3,
  x = '⚠️ Something went wrong. Please try again.';
function AIChatCard({ className: a, onClose: i }) {
  const s = [
      {
        sender: 'ai',
    ...
    { messages: o, setMessages: r, clearSession: l } = useChatSession(s),
    { updateMemory: d } = useChatMemory(),
    [h, m] = e.useState(''),
    { runChat: u, aiStatus: g, setAiStatus: y } = useChatCompletion(),
    w = e.useRef(o);
  (e.useEffect(() => {
  ...
  const v = e.useCallback(
      async (e) => {
        ...
        (r((e) => [...e, n]), m(''), y('thinking'));
        try {
          await new Promise((e) => setTimeout(e, f));
          const e = [
    ...
    S = e.useCallback(
      async (e, t) => {
        ...
        let n = -1;
        const a = o.map((a, i) =>
          a.id === e ? ((n = i), { ...a, text: t }) : a
        );
        if (-1 === n) return;
        const i = a.slice(0, n + 1);
        (r(i), y('thinking'));
        try {
          await new Promise((e) => setTimeout(e, f));
          const e = [{ sender: 'system', text: p, id: 'system-prompt' }, ...i],
            t = await u(e),
            n = {
              sender: 'ai',
              text: formatResponse(t),
    ...
    C = e.useCallback(async () => {
      if ('idle' !== g) return;
      const e = o.findLastIndex((e) => 'user' === e.sender);
      if (-1 !== e) {
        const n = o.slice(0, e + 1);
        try {
          await new Promise((e) => setTimeout(e, f));
    ...
    k = e.useCallback(() => {
      ...
      const e = new Date(),
        ...
        a = new Blob([t + $(!1)], { type: 'text/plain' }),
