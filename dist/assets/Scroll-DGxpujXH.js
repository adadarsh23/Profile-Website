...
import { l as C } from './index-Cxrg4Q2y.js';
class Face {
  constructor(t, i, e) {
...
class Vertex {
  constructor(t, i, e) {
    ((this.position = s(t, i, e)), (this.normal = h()), (this.uv = o()));
  }
}
class Geometry {
  constructor() {
    ...
    for (let s = 0; s < t; ++s) {
      ...
      (e.forEach((e, s) => {
        const n = this.getMidPoint(e.a, e.b, i),
          o = this.getMidPoint(e.b, e.c, i),
          a = this.getMidPoint(e.c, e.a, i),
          r = 4 * s;
        ((t[r + 0] = new Face(e.a, n, a)),
          (t[r + 1] = new Face(e.b, o, n)),
          (t[r + 2] = new Face(e.c, a, o)),
          (t[r + 3] = new Face(n, o, a)));
      }),
        (e = t));
    }
...
class ArcballControl {
  ...
  update(t, i = 16) {
    ...
    if (this.isPointerDown) {
      const t = 0.3 * e,
        i = 5 / e,
        n = b(o(), this.pointerPos, this.previousPointerPos);
      if ((T(n, n, t), M(n) > this.EPSILON)) {
        w(n, this.previousPointerPos, n);
        const t = this.#t(n),
        ...
        (E(this.previousPointerPos, n),
          (s *= i),
          this.quatFromVectors(o, a, this.pointerRotation, s));
      } else
        I(this.pointerRotation, this.pointerRotation, this.IDENTITY_QUAT, t);
    } else {
      const t = 0.1 * e;
      if (
        (I(this.pointerRotation, this.pointerRotation, this.IDENTITY_QUAT, t),
        ...
        const t = 0.2,
          ...
          o = _(i, e);
        ((s *= t * Math.max(0.1, 1 - 10 * o)),
          this.quatFromVectors(i, e, n, s));
      }
    }
    const a = y(P(), n, this.pointerRotation);
    ((this.orientation = y(P(), a, this.orientation)),
      D(this.orientation, this.orientation));
    const r = 0.8 * e;
    (I(this._combinedQuat, this._combinedQuat, a, r),
      D(this._combinedQuat, this._combinedQuat));
  ...
  quatFromVectors(t, i, e, s = 1) {
    const n = S(h(), t, i);
    g(n, n);
    const o = Math.max(-1, Math.min(1, R(t, i))),
      a = Math.acos(o) * s;
    return (U(e, n, a), { q: e, axis: n, angle: a });
  }
  #t(t) {
    ...
    let r = 0;
    const c = o * o + a * a;
    return ((r = c <= 2 ? Math.sqrt(4 - c) : 4 / Math.sqrt(c)), s(-o, a, r));
  }
}
class InfiniteGridMenu {
  ...
  #o(t) {
    ...
    ((this.viewportSize = a(this.canvas.clientWidth, this.canvas.clientHeight)),
      ...
      (this.discProgram = (function (t, i, e, s) {
        ...
        if (
          ([t.VERTEX_SHADER, t.FRAGMENT_SHADER].forEach((e, s) => {
            ...
            o && t.attachShader(n, o);
          }),
          s)
        )
          for (const o in s) t.bindAttribLocation(n, s[o], o);
        return (
          t.linkProgram(n),
      ...
      (this.discVAO = (function (t, i, e) {
        ...
        t.bindVertexArray(s);
        for (const [n, o, a] of i)
          -1 !== o &&
            (t.bindBuffer(t.ARRAY_BUFFER, n),
            t.enableVertexAttribArray(o),
            t.vertexAttribPointer(o, a, t.FLOAT, !1, 0, 0));
        if (e) {
      ...
      Promise.all(
        ...
        (i.forEach((t, i) => {
          const e = (i % this.atlasSize) * n,
            o = Math.floor(i / this.atlasSize) * n;
          s.drawImage(t, e, o, n, n);
        }),
  ...
  #u() {
    const t = this.control.snapDirection,
      i = A(P(), this.control.orientation),
      e = c(h(), t, i);
    let s,
      n = -1;
    for (let o = 0; o < this.instancePositions.length; ++o) {
      const t = R(e, this.instancePositions[o]);
      t > n && ((n = t), (s = o));
    }
    return s;
  }
...
function InfiniteMenu({ items: e = [] }) {
  ...
  t.useEffect(() => {
    ...
    t &&
      (i = new InfiniteGridMenu(t, e.length ? e : z, handleActiveItem, r, (t) =>
        t.run()
      ));
    const handleResize = () => {
      i && i.resize();
...
function Scroll() {
  const e = t.useRef(null),
    s = V(e, { once: !0, amount: 0.05 });
  return i.jsx(L.section, {
    ref: e,
    className: 'bg-black',
    initial: 'hidden',
    ...
    children: i.jsx(L.div, {
      ...
      children: i.jsx(InfiniteMenu, { items: N }),
    }),
  });
}
