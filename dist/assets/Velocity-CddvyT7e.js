const __vite__mapDeps = (
  ...
  m = __vite__mapDeps,
  d = m.f ||
    (m.f = ['assets/ScrollVelocity-u2jZPt-e.js', 'assets/vendor-C8sBI81f.js'])
) => i.map((i) => d[i]);
import { r as e, a6 as t, j as i, m as a, _ as o } from './vendor-C8sBI81f.js';
const s = e.lazy(() =>
    o(() => import('./ScrollVelocity-u2jZPt-e.js'), __vite__mapDeps([0, 1]))
  ),
