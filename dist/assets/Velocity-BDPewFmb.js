const __vite__mapDeps = (
  ...
  m = __vite__mapDeps,
  d = m.f ||
    (m.f = ['assets/ScrollVelocity-DetFBKLa.js', 'assets/vendor-DEG5g0yW.js'])
) => i.map((i) => d[i]);
import { r as e, a7 as t, j as i, m as a, _ as o } from './vendor-DEG5g0yW.js';
const s = e.lazy(() =>
    o(() => import('./ScrollVelocity-DetFBKLa.js'), __vite__mapDeps([0, 1]))
  ),
