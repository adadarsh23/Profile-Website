const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      'assets/card-CB0Qe0QC.js',
      'assets/utils-BtE0PGZ8.js',
      'assets/button-CqWIn8Ak.js',
      'assets/bubble.module-YQKLPTNq.js',
      'assets/bubble-C_vl8Ga6.css',
    ])
) => i.map((i) => d[i]);
import { r as e, _ as t, j as i, m as a } from './vendor-C8sBI81f.js';
const s = [
    {
      title: 'Our Mission',
      description:
  ...
  n = e.lazy(() =>
    t(
      () => import('./index-BgDpI5-0.js').then((e) => e.a),
  ...
  ),
  {
    ...
    Card: e.lazy(() =>
      t(() => import('./card-CB0Qe0QC.js'), __vite__mapDeps([3, 1, 4])).then(
        (e) => ({ default: e.Card })
      )
    ),
    CardContent: e.lazy(() =>
  ...
  m = e.lazy(() =>
    t(() => import('./button-CqWIn8Ak.js'), __vite__mapDeps([5, 1, 4])).then(
      (e) => ({ default: e.Button })
    )
  );
function About() {
  const [x, h] = e.useState(null);
  e.useEffect(() => {
    t(
      ...
      x
        ? i.jsx(a.h2, {
            ...
            children: 'About Us'
              .split('')
              .map((e, t) =>
                i.jsx('span', { className: x.hoverText, children: e }, t)
              ),
          })
        : null,
    u = {
          ...
          i.jsx('div', {
            ...
            children: s.map((t, s) =>
              i.jsx(
                e.Suspense,
                {
                  fallback: i.jsx('div', { children: i.jsx(n, {}) }),
                  children: i.jsx(a.div, {
                    variants: u,
