const __vite__mapDeps = (
  ...
  m = __vite__mapDeps,
  d = m.f ||
    (m.f = ['assets/FuzzyText-Bpdq6kXB.js', 'assets/vendor-DEG5g0yW.js'])
) => i.map((i) => d[i]);
import { j as e, m as t, r as i, _ as n } from './vendor-DEG5g0yW.js';
import { L as s } from './index-Cxrg4Q2y.js';
const a = i.lazy(() =>
  n(() => import('./FuzzyText-Bpdq6kXB.js'), __vite__mapDeps([0, 1]))
);
function NotFound() {
  return e.jsx(t.div, {
    className:
