import{r as C,j as le}from"./vendor_react-CqoAiNkk.js";import{p as h,o as f,W as ce,aR as de,P as me,S as fe,aS as ge,q as pe,aT as ve,aU as B,aV as we,aW as A,aX as Pe,aY as xe,aZ as j,C as v,a_ as q,a$ as $,b0 as m,b1 as U,b2 as ye,b3 as Le,b4 as G,b5 as y,b6 as V}from"./vendor-o_G25PcJ.js";import"./vendor_react-dom-CqtPPDu3.js";const Te=({effectOptions:W={onSpeedUp:()=>{},onSlowDown:()=>{},distortion:"turbulentDistortion",length:400,roadWidth:10,islandWidth:2,lanesPerRoad:4,fov:90,fovSpeedUp:150,speedUp:2,carLightsFade:.4,totalSideLightSticks:20,lightPairsPerRoadWay:40,shoulderLinesWidthPercentage:.05,brokenLinesWidthPercentage:.1,brokenLinesLengthPercentage:.5,lightStickWidth:[.12,.5],lightStickHeight:[1.3,1.7],movingAwaySpeed:[60,80],movingCloserSpeed:[-120,-160],carLightsLength:[400*.03,400*.2],carLightsRadius:[.05,.14],carWidthPercentage:[.3,.5],carShiftX:[-.8,.8],carFloorSeparation:[0,5],colors:{roadColor:526344,islandColor:657930,background:0,shoulderLines:16777215,brokenLines:16777215,leftCars:[14177983,6770850,12732332],rightCars:[242627,941733,3294549],sticks:242627}}})=>{const H=C.useRef(null),L=C.useRef(null);return C.useEffect(()=>{if(L.current){L.current.dispose();const i=document.getElementById("lights");if(i)for(;i.firstChild;)i.removeChild(i.firstChild)}const b={uFreq:{value:new h(3,6,10)},uAmp:{value:new h(30,30,20)}},T={uFreq:{value:new f(5,2)},uAmp:{value:new f(25,15)}},I={uFreq:{value:new f(2,3)},uAmp:{value:new f(35,10)}},S={uFreq:{value:new V(4,8,8,1)},uAmp:{value:new V(25,5,10,10)}},M={uFreq:{value:new f(4,8)},uAmp:{value:new f(10,20)},uPowY:{value:new f(20,2)}};let w=i=>Math.sin(i)*.5+.5;const J={mountainDistortion:{uniforms:b,getDistortion:`
          uniform vec3 uAmp;
          uniform vec3 uFreq;
        ...
        `,getJS:(i,e)=>{let t=.02,o=b.uFreq.value,s=b.uAmp.value,r=new h(Math.cos(i*Math.PI*o.x+e)*s.x-Math.cos(t*Math.PI*o.x+e)*s.x,w(i*Math.PI*o.y+e)*s.y-w(t*Math.PI*o.y+e)*s.y,w(i*Math.PI*o.z+e)*s.z-w(t*Math.PI*o.z+e)*s.z),n=new h(2,2,2),u=new h(0,0,-5);return r.multiply(n).add(u)}},xyDistortion:{uniforms:T,getDistortion:`
          uniform vec2 uFreq;
          uniform vec2 uAmp;
          #define PI 3.14159265358979
          vec3 getDistortion(float progress){
