const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/PillNav-B3kcD66J.js',
      'assets/vendor-iWomKbAA.js',
      'assets/Footer-K2Nh8XGC.js',
      'assets/Home-CrgVNA0l.js',
      'assets/About-BJIxR8Wh.js',
      'assets/utils-DfWtT5OB.js',
      'assets/bubble.module-YQKLPTNq.js',
      'assets/bubble-C_vl8Ga6.css',
      'assets/Contact-C8Tj_LVz.js',
      'assets/Sample-BIcazaeI.js',
      'assets/Gallery-TqrSvaZf.js',
      'assets/GalleryData-CGnx4Rfw.js',
      'assets/Blog-DDI5KC3i.js',
      'assets/NotFound-CECEPyMI.js',
      'assets/AnalyticsTracker-DAx124T-.js',
      'assets/IpLogger-D3lqQRJC.js',
      'assets/ScrollToTopButton-DY1s2fhS.js',
      'assets/InternetStatus-SPM6esCI.js',
      'assets/CacheClean-BzqUSvwi.js',
      'assets/WebSocket-C54H5G00.js',
      'assets/LiquidCursor-HgCLibB8.js',
      'assets/WebShare-C5XrsHHA.js',
      'assets/SplashCursor-pF5LT4jC.js',
      'assets/SmoothScrollProvider-CaxjcAfJ.js',
      'assets/RobotFaceWrapper-CAoejEyp.js',
      'assets/GradualBlur-Co_pOVcU.js',
    ])
) => i.map((i) => d[i]);
import {
  r as e,
...
const x = e.memo(() =>
  ...
  _ = { userID: 'default-user-id', environment: f.environment };
...
const u = '/assets/Adarsh-BDG0zI57.png',
  j = e.lazy(() =>
    r(() => import('./PillNav-B3kcD66J.js'), __vite__mapDeps([0, 1]))
  );
function Navbar() {
  return n.jsx(t.nav, {
    role: 'navigation',
...
const b = s.lazy(() =>
    r(() => import('./Footer-K2Nh8XGC.js'), __vite__mapDeps([2, 1]))
  ),
  loadComponent = (e) =>
    s.lazy(() => e.catch((e) => ({ default: () => null }))),
  g = loadComponent(
    r(() => import('./Home-CrgVNA0l.js'), __vite__mapDeps([3, 1]))
  ),
  y = loadComponent(
    r(() => import('./About-BJIxR8Wh.js'), __vite__mapDeps([4, 1, 5, 6, 7]))
  ),
  E = loadComponent(
    r(() => import('./Contact-C8Tj_LVz.js'), __vite__mapDeps([8, 1]))
  ),
  v = loadComponent(
    r(() => import('./Sample-BIcazaeI.js'), __vite__mapDeps([9, 1]))
  ),
  P = loadComponent(
    r(() => import('./Gallery-TqrSvaZf.js'), __vite__mapDeps([10, 1, 11]))
  ),
  A = loadComponent(
    r(() => import('./Blog-DDI5KC3i.js'), __vite__mapDeps([12, 1]))
  ),
  L = loadComponent(
    r(() => import('./NotFound-CECEPyMI.js'), __vite__mapDeps([13, 1]))
  ),
  N = loadComponent(
    r(() => import('./AnalyticsTracker-DAx124T-.js'), __vite__mapDeps([14, 1]))
  ),
  T = loadComponent(
    r(() => import('./IpLogger-D3lqQRJC.js'), __vite__mapDeps([15, 1]))
  ),
  I = loadComponent(
    r(() => import('./ScrollToTopButton-DY1s2fhS.js'), __vite__mapDeps([16, 1]))
  ),
  O = loadComponent(
    r(() => import('./InternetStatus-SPM6esCI.js'), __vite__mapDeps([17, 1]))
  ),
  R = loadComponent(
    r(() => import('./CacheClean-BzqUSvwi.js'), __vite__mapDeps([18, 1]))
  ),
  D = loadComponent(
    r(() => import('./WebSocket-C54H5G00.js'), __vite__mapDeps([19, 1]))
  ),
  w = loadComponent(
    r(
      () => import('./LiquidCursor-HgCLibB8.js'),
      __vite__mapDeps([20, 1, 5])
    ).then((e) => ({ default: e.LiquidCursor }))
  ),
  S = loadComponent(
    r(() => import('./WebShare-C5XrsHHA.js'), __vite__mapDeps([21, 1]))
  ),
  k = loadComponent(
    r(() => import('./SplashCursor-pF5LT4jC.js'), __vite__mapDeps([22, 1]))
  ),
  V = loadComponent(
    r(
      () => import('./SmoothScrollProvider-CaxjcAfJ.js'),
      __vite__mapDeps([23, 1])
    )
  ),
  C = loadComponent(
    r(() => import('./RobotFaceWrapper-CAoejEyp.js'), __vite__mapDeps([24, 1]))
  ),
  B = loadComponent(
    r(() => import('./GradualBlur-Co_pOVcU.js'), __vite__mapDeps([25, 1]))
  );
function App() {
              ...
              children: n.jsxs(s.Fragment, {
                children: [
                  ...
                  n.jsxs('div', {
                    ...
                    children: [n.jsx(O, {}), n.jsx(I, {}), n.jsx(R, {})],
                  }),
                ],
              }),
            }),
