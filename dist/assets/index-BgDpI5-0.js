const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/PillNav-DIiBVsgG.js',
      'assets/vendor-C8sBI81f.js',
      'assets/Home-B-7WpE5m.js',
      'assets/About-DEeKAhGN.js',
      'assets/Contact-CBeIfMHd.js',
      'assets/Sample-TNXDG666.js',
      'assets/Blog-CiyYZTfa.js',
      'assets/NotFound-BevqarEy.js',
      'assets/AnalyticsTracker-C-SgmoHr.js',
      'assets/IpLogger-BirMuOQU.js',
      'assets/ScrollToTopButton-BUJSxeIm.js',
      'assets/InternetStatus-DhbRKPc_.js',
      'assets/CacheClean-CWSIXrp6.js',
      'assets/WebSocket-DYrsMY9_.js',
      'assets/LiquidCursor-CJsyNOgb.js',
      'assets/utils-BtE0PGZ8.js',
      'assets/SplashCursor-CVqLMVX9.js',
      'assets/SmoothScrollProvider-DswAK7iO.js',
      'assets/RobotFaceWrapper-CjfsQlmC.js',
      'assets/GradualBlur-D-Kg9prq.js',
    ])
) => i.map((i) => d[i]);
import {
  r as e,
...
const g = '/assets/Adarsh-BDG0zI57.png',
  y = e.lazy(() =>
    r(() => import('./PillNav-DIiBVsgG.js'), __vite__mapDeps([0, 1]))
  );
function Navbar() {
  return n.jsx(s.nav, {
    role: 'navigation',
...
const loadComponent = (e) =>
    t.lazy(() => e.catch((e) => ({ default: () => null }))),
  v = loadComponent(
    r(() => import('./Home-B-7WpE5m.js'), __vite__mapDeps([2, 1]))
  ),
  E = loadComponent(
    r(() => import('./About-DEeKAhGN.js'), __vite__mapDeps([3, 1]))
  ),
  w = loadComponent(
    r(() => import('./Contact-CBeIfMHd.js'), __vite__mapDeps([4, 1]))
  ),
  N = loadComponent(
    r(() => import('./Sample-TNXDG666.js'), __vite__mapDeps([5, 1]))
  ),
  A = loadComponent(
    r(() => import('./Blog-CiyYZTfa.js'), __vite__mapDeps([6, 1]))
  ),
  P = loadComponent(
    r(() => import('./NotFound-BevqarEy.js'), __vite__mapDeps([7, 1]))
  ),
  k = loadComponent(
    r(() => import('./AnalyticsTracker-C-SgmoHr.js'), __vite__mapDeps([8, 1]))
  ),
  L = loadComponent(
    r(() => import('./IpLogger-BirMuOQU.js'), __vite__mapDeps([9, 1]))
  ),
  T = loadComponent(
    r(() => import('./ScrollToTopButton-BUJSxeIm.js'), __vite__mapDeps([10, 1]))
  ),
  I = loadComponent(
    r(() => import('./InternetStatus-DhbRKPc_.js'), __vite__mapDeps([11, 1]))
  ),
  R = loadComponent(
    r(() => import('./CacheClean-CWSIXrp6.js'), __vite__mapDeps([12, 1]))
  ),
  O = loadComponent(
    r(() => import('./WebSocket-DYrsMY9_.js'), __vite__mapDeps([13, 1]))
  ),
  S = loadComponent(
    r(
      () => import('./LiquidCursor-CJsyNOgb.js'),
      __vite__mapDeps([14, 1, 15])
    ).then((e) => ({ default: e.LiquidCursor }))
  ),
  D = loadComponent(
    r(() => import('./SplashCursor-CVqLMVX9.js'), __vite__mapDeps([16, 1]))
  ),
  C = loadComponent(
    r(
      () => import('./SmoothScrollProvider-DswAK7iO.js'),
      __vite__mapDeps([17, 1])
    )
  ),
  V = loadComponent(
    r(() => import('./RobotFaceWrapper-CjfsQlmC.js'), __vite__mapDeps([18, 1]))
  ),
  B = loadComponent(
    r(() => import('./GradualBlur-D-Kg9prq.js'), __vite__mapDeps([19, 1]))
  );
function App() {
              ...
              children: n.jsx(e.Suspense, {
                ...
                children: n.jsx(c, {
                  children: [
                    ...
                    { path: '/about', element: n.jsx(E, {}) },
                    { path: '/contact', element: n.jsx(w, {}) },
                    { path: '/sample', element: n.jsx(N, {}) },
                    { path: '/blog', element: n.jsx(A, {}) },
                    { path: '*', element: n.jsx(P, {}) },
                  ].map(({ path: a, element: t }) =>
                    n.jsx(
                      d,
                      {
                        path: a,
          ...
          n.jsx(ErrorBoundary, {
            ...
            children: n.jsx(e.Suspense, {
              ...
              children: n.jsxs('div', {
                ...
                children: [n.jsx(I, {}), n.jsx(T, {}), n.jsx(R, {})],
              }),
            }),
          }),
...
const z = parseFloat('1.0');
const initGA = () => {
    h.initialize('G-X34L2QSKRG');
  },
  trackPage = (e) => {
    h.send({ hitType: 'pageview', page: e });
  },
  F = document.getElementById('root'),
  H = x.createRoot(F);
if (!t.Children) throw new Error('React initialization failed');
(p.init('o4jvc9/adadarsh23'),
  p.identify('8n7x7x4nxn63837x3n83nx838xn3n3863x836n48638', {
    name: 'Adarsh',
  ...
  initGA(),
  H.render(
    n.jsx(t.StrictMode, { children: n.jsx(f, { children: n.jsx(App, {}) }) })
  ));
export {
  ErrorBoundary as E,
  u as L,
