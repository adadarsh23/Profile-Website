const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      'assets/card-B3bMxOxK.js',
      'assets/utils-xZivFseN.js',
      'assets/button-wiFhq-Fa.js',
    ])
) => i.map((i) => d[i]);
...
const r = [
  ...
  ),
  {
    ...
    Card: t.lazy(() =>
      s(() => import('./card-B3bMxOxK.js'), __vite__mapDeps([3, 1, 4])).then(
        (e) => ({ default: e.Card })
      )
    ),
    CardContent: t.lazy(() =>
  ...
  x = t.lazy(() =>
    s(() => import('./button-wiFhq-Fa.js'), __vite__mapDeps([5, 1, 4])).then(
      (e) => ({ default: e.Button })
    )
  );
function About() {
  const BubbleText = () =>
    e.jsx(a.h2, {
      ...
      children: 'About Us'
        .split('')
        .map((t, a) =>
          e.jsx('span', { className: i.hoverText, children: t }, a)
        ),
    });
  return e.jsxs('div', {
    className:
