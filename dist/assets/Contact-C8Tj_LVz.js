const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/Map-BVW5UTJi.js',
      'assets/vendor-iWomKbAA.js',
      'assets/bubble.module-YQKLPTNq.js',
      'assets/bubble-C_vl8Ga6.css',
    ])
) => i.map((i) => d[i]);
import { r as e, _ as t, j as a, m as s, A as i } from './vendor-iWomKbAA.js';
const l = e.lazy(() =>
  t(() => import('./Map-BVW5UTJi.js'), __vite__mapDeps([0, 1]))
);
function Contact() {
        ...
        children: [
          ...
          'textarea' === s
            ? a.jsx('textarea', {
                ...
                name: e,
                required: !0,
                className: `w-full p-3 rounded-lg border border-gray-300 bg-white text-black focus:ring-2 focus:ring-black outline-none transition-all ${l.className}`,
                ...l,
              })
            : a.jsx('input', {
                id: e,
  ...
  return a.jsxs('div', {
    ...
    children: [
      a.jsx(e.Suspense, {
        fallback: a.jsx('div', { className: 'absolute inset-0 bg-black' }),
        children: a.jsx(l, {
          interactive: !1,
      ...
      a.jsx('div', { className: 'absolute inset-0 bg-black/60 z-0' }),
      a.jsx(BubbleText, {}),
      a.jsx(s.div, {
                ...
                s.form,
                {
                  ...
                  children: [
                    [
                      ...
                      a.jsx(
                        s.div,
                        { variants: u, children: a.jsx(FormInput, { ...e }) },
                        e.id
                      )
                    ),
                    a.jsx(s.div, {
