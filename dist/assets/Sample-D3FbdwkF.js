...
import { Z as p } from './vendor-Grk_15WJ.js';
...
const t = [
  ...
  o = a.lazy(() =>
    i(() => import('./Beats-BV5M0bxO.js'), __vite__mapDeps([0, 1, 2, 3]))
  ),
  n = () =>
    e.jsx(p.h2, {
      className:
      ...
      children: 'Free Sample'
        .split('')
        .map((s, m) =>
          e.jsx('span', { className: l.hoverText, children: s }, m)
        ),
    });
function u() {
  return e.jsxs('section', {
    className:
      'relative bg-black text-white min-h-screen flex flex-col items-center justify-start py-24 px-4 sm:px-6 lg:px-8',
    children: [
      e.jsx(n, {}),
      e.jsx('div', {
