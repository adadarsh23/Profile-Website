const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/RobotHead-CuFjD1ge.js',
      'assets/vendor-CLKqtzgM.js',
      'assets/AIChatCard-DOoxck43.js',
...
import './index-TjyNd_uT.js';
import { c as x } from './utils-xZivFseN.js';
const g = t,
  w = a,
  b = n,
  y = e.forwardRef(({ className: e, ...t }, a) =>
    s.jsx(c, {
      className: x(
...
const R = e.memo(() =>
  ...
  L = e.lazy(() =>
    p(() => import('./RobotHead-CuFjD1ge.js'), __vite__mapDeps([0, 1]))
  ),
  A = e.lazy(() =>
    p(
      () => import('./AIChatCard-DOoxck43.js'),
    ...
    children: s.jsxs(g, {
      ...
      children: [
        ...
        s.jsxs(j, {
          ...
          children: [
            s.jsx(N, { className: 'sr-only', children: 'AD Assistant' }),
            s.jsx(E, {
              className: 'sr-only',
              children:
