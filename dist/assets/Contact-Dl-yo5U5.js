const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/Map-BbP92-Ad.js',
      'assets/vendor_react-C8wG62CJ.js',
      'assets/vendor-Grk_15WJ.js',
      'assets/vendor_react-dom-DKAsGG5-.js',
    ])
) => i.map((i) => d[i]);
import { r as i, j as e, _ as g } from './vendor_react-C8wG62CJ.js';
import { s as f } from './bubble.module-Bdvz9-Ck.js';
import { Z as l, $ as w } from './vendor-Grk_15WJ.js';
import './vendor_react-dom-DKAsGG5-.js';
const j = i.lazy(() =>
  g(() => import('./Map-BbP92-Ad.js'), __vite__mapDeps([0, 1, 2, 3]))
);
function z() {
  const [d, u] = i.useState(!1),
    ...
    [x, n] = i.useState(null),
    p = async (t) => {
      (t.preventDefault(), n(null), m(!0));
      const a = t.target,
        o = new FormData(a);
      try {
        const r = await fetch('https://formspree.io/f/xjkeqraa', {
          method: 'POST',
          body: o,
        ...
        if (r.ok) (u(!0), a.reset());
          ...
          n(s.error || 'Something went wrong. Please try again.');
        }
      } catch {
        n('Network error. Please check your connection and try again.');
      }
      m(!1);
    },
    b = () =>
      e.jsx(l.h2, {
        ...
        children: 'Get In Touch'
          .split('')
          .map((t, a) =>
            e.jsx('span', { className: f.hoverText, children: t }, a)
          ),
      }),
    h = [
    ...
    y = ({ id: t, label: a, type: o, autoComplete: r, props: s = {} }) =>
      e.jsxs('div', {
        ...
        children: [
          ...
          o === 'textarea'
            ? e.jsx('textarea', {
                ...
                name: t,
                required: !0,
                className: `w-full p-3 rounded-lg border border-gray-300 bg-white text-black focus:ring-2 focus:ring-black outline-none transition-all ${s.className}`,
                ...s,
              })
            : e.jsx('input', {
                id: t,
  ...
  return e.jsxs('div', {
    ...
    children: [
      e.jsx(i.Suspense, {
        fallback: e.jsx('div', { className: 'absolute inset-0 bg-black' }),
        children: e.jsx(j, {
          interactive: !1,
      ...
      e.jsx('div', { className: 'absolute inset-0 bg-black/60 z-0' }),
      e.jsx(b, {}),
      e.jsx(l.div, {
