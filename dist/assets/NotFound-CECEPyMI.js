const __vite__mapDeps = (
  ...
  m = __vite__mapDeps,
  d = m.f ||
    (m.f = ['assets/FuzzyText-D6zJffdH.js', 'assets/vendor-iWomKbAA.js'])
) => i.map((i) => d[i]);
import { j as e, m as t, r as i, _ as n } from './vendor-iWomKbAA.js';
import { L as s } from './index-Bkc3ae4Q.js';
const a = i.lazy(() =>
  n(() => import('./FuzzyText-D6zJffdH.js'), __vite__mapDeps([0, 1]))
);
function NotFound() {
  return e.jsx(t.div, {
    className:
