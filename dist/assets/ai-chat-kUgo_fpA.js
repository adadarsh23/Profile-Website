import { r, j as e, Y as p } from './vendor_react-C8wG62CJ.js';
import { c as m } from './utils-x720GUhr.js';
import { Z as a } from './vendor-Grk_15WJ.js';
import './vendor_react-dom-DKAsGG5-.js';
function y({ className: u }) {
    ...
    children: [
      ...
      e.jsxs('div', {
        ...
        children: [
          e.jsx(a.div, {
            className:
              'absolute inset-0 bg-gradient-to-br from-gray-800 via-black to-gray-900',
            animate: { backgroundPosition: ['0% 0%', '100% 100%', '0% 0%'] },
            transition: { duration: 20, repeat: 1 / 0, ease: 'linear' },
            style: { backgroundSize: '200% 200%' },
          }),
          Array.from({ length: 20 }).map((t, s) =>
            e.jsx(
              a.div,
              {
          ...
          e.jsx('div', {
            className: 'px-4 py-3 border-b border-white/10 relative z-10',
            children: e.jsx('h2', {
          ...
          e.jsxs('div', {
            ...
            children: [
              ...
              x &&
                e.jsxs(a.div, {
                  className:
                    'flex items-center gap-1 px-3 py-2 rounded-xl max-w-[30%] bg-white/10 self-start',
                  initial: { opacity: 0 },
                  animate: { opacity: [0, 1, 0.6, 1] },
                  transition: { repeat: 1 / 0, duration: 1.2 },
                  children: [
                    e.jsx('span', {
                    ...
                    e.jsx('span', {
                      className:
                        'w-2 h-2 rounded-full bg-white animate-pulse delay-200',
                    }),
                    e.jsx('span', {
                      className:
                        'w-2 h-2 rounded-full bg-white animate-pulse delay-400',
                    }),
                  ],
                }),
            ],
