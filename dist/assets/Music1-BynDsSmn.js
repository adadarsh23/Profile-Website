...
import { r as i, _ as s, j as t, m as e } from './vendor-C8sBI81f.js';
const a = [
    {
      id: 1,
      artist: 'Âd Adarsh',
  ...
  r = i.lazy(() =>
    s(() => import('./MusicArt-D5Bdd-h_.js'), __vite__mapDeps([0, 1, 2]))
  ),
  BubbleText = ({ styles: i }) =>
    i
      ? t.jsx(e.h2, {
