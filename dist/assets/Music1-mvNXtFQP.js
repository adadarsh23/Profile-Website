...
import { r as i, _ as s, j as t, m as e } from './vendor-iWomKbAA.js';
import { L as a } from './index-Bkc3ae4Q.js';
const r = [
    {
      id: 1,
      artist: 'Âd Adarsh',
  ...
  n = i.lazy(() =>
    s(() => import('./MusicArt-C5-AHeof.js'), __vite__mapDeps([0, 1, 2]))
  ),
  BubbleText = ({ styles: i }) =>
    i
      ? t.jsx(e.h2, {
