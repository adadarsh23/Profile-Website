import { j as e, S as t, g as a, m as s } from './vendor-iWomKbAA.js';
import { c as i } from './utils-DfWtT5OB.js';
import r from './bubble.module-YQKLPTNq.js';
const n = [
  {
    title: 'Our Mission',
    description:
...
function CardHeader({ className: t, ...a }) {
  return e.jsx('div', {
...
function CardTitle({ className: t, ...a }) {
  return e.jsx('div', {
...
function CardDescription({ className: t, ...a }) {
  return e.jsx('div', {
...
function CardContent({ className: t, ...a }) {
  return e.jsx('div', {
...
function Button({ className: a, variant: s, size: r, asChild: n = !1, ...d }) {
  const l = n ? t : 'button';
  return e.jsx(l, {
    'data-slot': 'button',
    className: i(o({ variant: s, size: r, className: a })),
    ...d,
  });
}
function About() {
  const BubbleText = () =>
      e.jsx(s.h2, {
        ...
        children: 'About Us'
          .split('')
          .map((t, a) =>
            e.jsx('span', { className: r.hoverText, children: t }, a)
          ),
      }),
    t = {
            ...
            children: n.map((a, i) =>
              e.jsx(
                s.div,
                {
                  ...
                  className: 'h-full',
                  children: e.jsxs(Card, {
                    className: 'bg-black-900 border border-gray-700 h-full',
                    children: [
                      e.jsx(CardHeader, {
                        children: e.jsx(CardTitle, {
                          className: 'text-white text-xl',
                          children: a.title,
                        }),
                      }),
                      e.jsx(CardContent, {
                        children: e.jsx(CardDescription, {
