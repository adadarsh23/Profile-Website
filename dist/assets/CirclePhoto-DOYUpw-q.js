const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/CircularGallery-C-3n2yTO.js',
...
const r = a.lazy(() =>
    s(() => import('./CircularGallery-C-3n2yTO.js'), __vite__mapDeps([0, 1, 2]))
  ),
  BubbleText = ({ isInView: e, styles: t }) =>
    i.jsx(l.h2, {
      className:
      ...
      animate: e ? { y: 0, opacity: 1 } : {},
      transition: { duration: 0.6, ease: 'easeOut' },
      children: 'PhotoGraphy'
        .split('')
        .map((e, a) =>
          i.jsx('span', { className: t?.hoverText, children: e }, a)
        ),
    });
function CirclePhoto() {
  const { ref: n, inView: o } = e({}),
    [c, x] = t.useState(null);
  return (
    a.useEffect(() => {
      s(
    ...
    i.jsxs('section', {
      ...
      children: [
        ...
        i.jsx(BubbleText, { isInView: o, styles: c }),
        i.jsx(l.p, {
