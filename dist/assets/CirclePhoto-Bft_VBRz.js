...
import { s as d } from './bubble.module-BuxepTIR.js';
const u = [
...
class Media {
  ...
  createShader() {
    const e = new a(this.gl, { generateMipmaps: !0 });
    this.program = new r(this.gl, {
      depthTest: !1,
      depthWrite: !1,
      vertex:
  ...
  update(e, t) {
    ...
    const s = this.plane.position.x,
      i = this.viewport.width / 2;
    if (0 === this.bend)
      ((this.plane.position.y = 0), (this.plane.rotation.z = 0));
    else {
      const e = Math.abs(this.bend),
        t = (i * i + e * e) / (2 * e),
        n = Math.min(Math.abs(s), i),
        o = t - Math.sqrt(t * t - n * n);
      this.bend > 0
        ? ((this.plane.position.y = -o),
          (this.plane.rotation.z = -Math.sign(s) * Math.asin(n / t)))
        : ((this.plane.position.y = o),
          (this.plane.rotation.z = Math.sign(s) * Math.asin(n / t)));
    }
...
class App {
  ...
  createMedias(e, t = 1, s) {
    const i = e && e.length ? e : u;
    ((this.mediasImages = i.concat(i)),
  ...
  onTouchMove(e) {
    ...
    const t = e.touches ? e.touches[0].clientX : e.clientX,
      s = (this.start - t) * (0.025 * this.scrollSpeed);
  ...
  onResize() {
    ...
    const e = (this.camera.fov * Math.PI) / 180,
      ...
      s = t * this.camera.aspect;
    ((this.viewport = { width: s, height: t }),
      this.medias &&
  ...
  update() {
    ...
    this.scroll.current =
      ...
      (s = this.scroll.ease),
      e + (t - e) * s);
    const i = this.scroll.current > this.scroll.last ? 'right' : 'left';
    (this.medias && this.medias.forEach((e) => e.update(this.scroll, i)),
...
function CircularGallery({
  ...
  textColor: n = '#ffffff',
  borderRadius: o = 0.05,
  font: a = "bold 30px 'Bitcount Grid Double', system-ui, sans-serif",
  scrollSpeed: r = 2,
  scrollEase: h = 0.05,
}) {
    ...
    BubbleText = () =>
      t.jsx(c.h2, {
        ...
        children: 'PhotoGraphy'
          .split('')
          .map((e, s) =>
            t.jsx('span', { className: d.hoverText, children: e }, s)
          ),
      });
  return t.jsxs('section', {
    ...
    children: [
      ...
      t.jsx(c.div, {
        ...
        children: t.jsx(CircularGallery, {
          bend: 2,
          textColor: '#ffffff',
          borderRadius: 0.05,
          scrollEase: 0.05,
