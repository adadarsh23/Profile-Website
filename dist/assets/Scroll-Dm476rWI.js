...
import { l as V } from './index-TjyNd_uT.js';
class Face {
  constructor(t, i, e) {
...
class ArcballControl {
  ...
  update(t, i = 16) {
    ...
    if (this.isPointerDown) {
      const t = 0.3 * e,
        i = 5 / e,
        n = T(o(), this.pointerPos, this.previousPointerPos);
      if ((b(n, n, t), M(n) > this.EPSILON)) {
...
class InfiniteGridMenu {
  ...
  #d() {
    (u(this.camera.matrix, this.camera.position, [0, 0, 0], this.camera.up),
      p(this.camera.matrices.view, this.camera.matrix));
  }
  #a(t) {
...
function InfiniteMenu({ items: e = [] }) {
  ...
  t.useEffect(() => {
    ...
    t &&
      (i = new InfiniteGridMenu(t, e.length ? e : L, handleActiveItem, r, (t) =>
        t.run()
      ));
    const handleResize = () => {
      i && i.resize();
...
function Scroll() {
  const t = [
    ...
    {
      image: '/assets/spotify-D_PSz9Uq.png',
  ...
  return i.jsx('section', {
    ...
    children: i.jsx('div', {
      ...
      children: i.jsx(InfiniteMenu, { items: t }),
    }),
  });
}
